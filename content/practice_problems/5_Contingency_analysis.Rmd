...
P value is less than 0.05, so we reject the null that heart attacks are
unrelated to sex
...
fail to reject null, age does not impact heart attacks
...
```{r}
table <- as.table(matrix(c(7, 1, 3, 87, 18, 84, 12, 3, 4, 9, 1, 7), nrow = 4, byrow = T))

fisher.test(table)
```

You fail to reject the null, as the p value is greater than 0.05
